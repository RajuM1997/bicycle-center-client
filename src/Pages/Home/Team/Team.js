      ...
      <div className="container pb-5">
        ...
        <div className="row">
          ...
          <div className="col-md-4">
            <div className="card h-100">
              ...
              <div className="card-body text-center">
                ...
                <p className="card-text">Manager(Production)</p>
                <button className="common-btn">Read More</button>
              </div>
            </div>
          </div>
          <div className="col-md-4">
            <div className="card h-100">
              ...
              <div className="card-body text-center">
                ...
                <p className="card-text">Manager(Marketing)</p>
                <button className="common-btn">Read More</button>
              </div>
            </div>
          </div>
          <div className="col-md-4">
            <div className="card h-100">
              <img
                src="https://images.unsplash.com/photo-1583195764036-6dc248ac07d9?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=876&q=80"
                className="d-block"
                alt="..."
              />
              <div className="card-body text-center">
                <h5 className="card-title">Darius J. Mike</h5>
                <p className="card-text">HR Officer</p>
                <button className="common-btn">Read More</button>
              </div>
            </div>
          </div>
          <div className="col-md-4">
            <div className="card h-100">
              <img
                src="https://images.unsplash.com/photo-1553837851-341a0c2509e5?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=871&q=80"
                className="d-block"
                alt="..."
              />
              <div className="card-body text-center">
                <h5 className="card-title">Darius J. Mike</h5>
                <p className="card-text">Sales Officer</p>
                <button className="common-btn">Read More</button>
              </div>
            </div>
          </div>
          <div className="col-md-4">
            <div className="card h-100">
              <img
                src="https://images.unsplash.com/photo-1592827095305-68f21edefb82?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=870&q=80"
                className="d-block"
                alt="..."
              />
              <div className="card-body text-center">
                <h5 className="card-title">Darius J. Mike</h5>
                <p className="card-text">Admin Officer</p>
                <button className="common-btn">Read More</button>
              </div>
            </div>
          </div>
